  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full sm:max-w-lg rounded-t-2xl sm:rounded-xl shadow-2xl max-h-[90dvh] overflow-y-auto relative"
        style={{
          background: "var(--card)",
      ...
      >
        ...
        <div className="p-5 pb-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="font-bold text-[#2C1810] dark:text-[#F5EDD8]"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Input placeholder={isQuestion ? "Formule ta question..." : "Mot, concept, idée..."} value={title} onChange={(e) => setTitle(e.target.value)} required />
            </div>
              ...
              {imagePreview ? (
                <div className="relative rounded-lg overflow-hidden">
                  ...
                  <button type="button"
                    ...
                    className="absolute top-2 right-2 w-7 h-7 bg-[#2C1810]/60 rounded-md flex items-center justify-center text-[#F5EDD8] hover:bg-[#2C1810]/80">
                ...
                <div onDrop={handleDrop} onDragOver={(e) => { e.preventDefault(); setDragOver(true); }} onDragLeave={() => setDragOver(false)}
                  ...
                  <p className="text-xs text-[var(--muted)]" style={{ fontFamily: "Georgia, serif" }}>
                    Glisse ou <span style={{ color: "#C9A84C" }}>clique</span>
                  </p>
                </div>
              )}
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button type="button" onClick={() => setShowTagForm(!showTagForm)}
                  ...
                  style={{ borderColor: "#D4B896", color: "#8B6F4E", fontFamily: "Georgia, serif" }}>
